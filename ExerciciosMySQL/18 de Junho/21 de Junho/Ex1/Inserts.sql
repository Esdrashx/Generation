...
INSERT INTO tb_classe(carreira, sexo, estilo)
	VALUES
...
INSERT INTO tb_personagem(nome, poder_ataque, poder_defesa, vida, habilidade, cp_classe)
	VALUES 
...
UPDATE tb_classe SET carreira = "Arqueiro" WHERE id_classe = 1;  
