...
INNER JOIN tabela_personagem ON tabela_personagem.fk_classe = tabela_classe.id_classe
ORDER BY nome ASC;

SELECT tabela_personagem.nome "Nome:", tabela_classe.carreira "Carreira:" 
FROM tabela_personagem
INNER JOIN tabela_classe ON tabela_classe.id_classe = tabela_personagem.fk_classe
